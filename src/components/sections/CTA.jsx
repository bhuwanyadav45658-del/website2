    ...
    return (
        <section className="relative py-32 px-6 flex items-center justify-center overflow-hidden bg-background">
            ...
            <div className="relative z-10 text-center max-w-4xl mx-auto">
                ...
                >
                    Ready to Scale Your <span className="text-primaryGlow">Digital Presence?</span>
                </motion.h2>
                ...
                >
                    From custom development to intelligent AI integration, we build the future of your business.
                </motion.p>
